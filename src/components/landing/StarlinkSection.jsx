  ...
  return (
    <section className="py-section-gap relative overflow-hidden" id="starlink">
      ...
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        <div className="glass-panel rounded-3xl p-10 md:p-16 relative overflow-hidden border border-primary/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
                <Link
                  href="/catalog"
                  className="gold-btn font-label-bold text-label-bold px-10 py-4 rounded-full tracking-widest text-xs font-black shadow-[0_0_20px_rgba(242,202,80,0.2)]"
                >
